    ...
    public function query()
    {
        if($this->idAlumno != 0 and $this->idGrupo != 0 and $this->idEscuela != 0){
            ...
            ->select(
                ...
                DB::raw('JSON_EXTRACT(resultados.persepcion_riesgo,"$.Tabaco")'),
                DB::raw('JSON_EXTRACT(resultados.persepcion_riesgo,"$.Alcohol")'),
                DB::raw('JSON_EXTRACT(resultados.persepcion_riesgo,"$.Otras_drogas")'),
                DB::raw('JSON_EXTRACT(resultados.persepcion_riesgo,"$.total")'),
                ...
                DB::raw('JSON_EXTRACT(resultados.consumo_sustancias,"$.Tabaco")'),
                DB::raw('JSON_EXTRACT(resultados.consumo_sustancias,"$.Alcohol")'),
                DB::raw('JSON_EXTRACT(resultados.consumo_sustancias,"$.Otras_drogas")'),
                DB::raw('JSON_EXTRACT(resultados.consumo_sustancias,"$.total")'),
            ...
            ->select(
                ...
                DB::raw('CAST(SUM(JSON_EXTRACT(resultados.persepcion_riesgo,"$.total")) AS CHAR)'),
                DB::raw('CAST(SUM(JSON_EXTRACT(resultados.persepcion_riesgo,"$.Tabaco")) AS CHAR)'), 
                DB::raw('CAST(SUM(JSON_EXTRACT(resultados.persepcion_riesgo,"$.Alcohol")) AS CHAR)'), 
                DB::raw('CAST(SUM(JSON_EXTRACT(resultados.persepcion_riesgo,"$.Otras_drogas")) AS CHAR)'),
                ...
                DB::raw('CAST(SUM(JSON_EXTRACT(resultados.consumo_sustancias,"$.total")) AS CHAR)'),
                DB::raw('CAST(SUM(JSON_EXTRACT(resultados.consumo_sustancias,"$.Tabaco")) AS CHAR)'),
                DB::raw('CAST(SUM(JSON_EXTRACT(resultados.consumo_sustancias,"$.Alcohol")) AS CHAR)'),
                DB::raw('CAST(SUM(JSON_EXTRACT(resultados.consumo_sustancias,"$.Otras_drogas")) AS CHAR)'),
