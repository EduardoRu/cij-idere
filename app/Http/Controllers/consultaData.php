...
class consultaData extends Controller
{
    ...
    public function index()
    {
        ...
        ->select(
            ...
            DB::raw('SUM(JSON_EXTRACT(resultados.persepcion_riesgo,"$.total")) AS "PR"'),
            ...
            DB::raw('SUM(JSON_EXTRACT(resultados.consumo_sustancias,"$.total")) AS "CS"'),
        ...
        ->select(
            ...
            DB::raw('JSON_EXTRACT(resultados.persepcion_riesgo,"$.total") AS "PR"'),
            ...
            DB::raw('JSON_EXTRACT(resultados.consumo_sustancias,"$.total") AS "CS"'),
        ...
        if((Grupo::where('idgrupos', $request->input('GRES'))->first()) != null){
            ...
            if((Clave_alumno::where('idclave_alumno', $request->input('ALES'))->first()) != null){
                ...
                ->select(
                    ...
                    DB::raw('resultados.disp_sustancias_expect_consumo AS "DSEC"'), 
                    DB::raw('JSON_EXTRACT(resultados.persepcion_riesgo,"$.total") AS "PR"'), 
                    DB::raw('JSON_EXTRACT(resultados.persepcion_riesgo,"$.Tabaco") AS "PRT"'), 
                    DB::raw('JSON_EXTRACT(resultados.persepcion_riesgo,"$.Alcohol") AS "PRA"'), 
                    DB::raw('JSON_EXTRACT(resultados.persepcion_riesgo,"$.Otras_drogas") AS "PRO"'),
                    DB::raw('resultados.desempeno_escolar AS "DE"'), 
                    DB::raw('resultados.violencia AS "VI"'), 
                    DB::raw('resultados.riesgo_inicio_incremento_consumo AS "RIIC"'),
                    DB::raw('JSON_EXTRACT(resultados.consumo_sustancias,"$.total") AS "CS"'),
                    DB::raw('JSON_EXTRACT(resultados.consumo_sustancias,"$.Tabaco") AS "CST"'),
                    DB::raw('JSON_EXTRACT(resultados.consumo_sustancias,"$.Alcohol") AS "CSA"'),
                    DB::raw('JSON_EXTRACT(resultados.consumo_sustancias,"$.Otras_drogas") AS "CSO"'),
                    DB::raw('resultados.participacion_acciones_preventivas AS "PAP"'),
                )
            ...
            ->select(
                ...
                DB::raw('SUM(resultados.disp_sustancias_expect_consumo) AS "DSEC"'), 
                DB::raw('SUM(JSON_EXTRACT(resultados.persepcion_riesgo,"$.total")) AS "PR"'),
                DB::raw('SUM(JSON_EXTRACT(resultados.persepcion_riesgo,"$.Tabaco")) AS "PRT"'), 
                DB::raw('SUM(JSON_EXTRACT(resultados.persepcion_riesgo,"$.Alcohol")) AS "PRA"'), 
                DB::raw('SUM(JSON_EXTRACT(resultados.persepcion_riesgo,"$.Otras_drogas")) AS "PRO"'),
                DB::raw('SUM(resultados.desempeno_escolar) AS "DE"'), 
                DB::raw('SUM(resultados.violencia) AS "VI"'), 
                DB::raw('SUM(resultados.riesgo_inicio_incremento_consumo) AS "RIIC"'),
                DB::raw('SUM(JSON_EXTRACT(resultados.consumo_sustancias,"$.total")) AS "CS"'),
